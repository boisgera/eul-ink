...
# ------------------------------------------------------------------------------
csvfile = open("../Questionnaire Maths 3 2018.csv")

reader = csv.reader(csvfile, delimiter=",", quotechar='"')
test = []
hists = [(3, "niveau"), (4, "interet"), 
         (7, "format-cours"), (8, "encadrant-cours"), (9, "contenu-cours"),
         (13, "encadrant-PC"), (14, "contenu-PC"),
         (17, "encadrant-atelier"), (18, "contenu-atelier"),
         (20, "poly"), (21, "anglais"),
         (24, "satisfaction")
        ]
...
RESOURCES = [
  ...
  "Documents de la session 2017 (sujet d'examen corrigé, distribution des notes, résultats des questionnaires)",
]
...
#        print("item:", item)
    ...
    sessions = [s.strip() for s in row[10].split(";")]
    #print(sessions)
    ...
    resources = [r.strip() for r in row[22].split(";")]
...
# ------------------------------------------------------------------------------
m = 5
y_pos = m*(9 - np.arange(len(SESSIONS)))
...
pp.axis([0.0, 100.0, 0.0, m*10])
#pp.gca().get_yaxis().set_visible(False)
pp.yticks(y_pos, range(1,10))
